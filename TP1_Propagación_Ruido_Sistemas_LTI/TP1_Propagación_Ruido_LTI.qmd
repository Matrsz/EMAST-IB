...
![Diagrama](Images/fig3.svg){#fig-3}
...
fig, ax = plt.subplots(3,1, sharex=True)
fig.suptitle('Respuestas al impulso del sistema', fontsize=16)
ax[0].plot(T, n_t)
ax[1].plot(T, pos)
ax[2].plot(T, vel)
...
La @fig-dep indica que $H_{T0}$ actúa como un filtro pasa bajo, mientras que $H_{T1}$ actúa como un filtro pasa banda. Esto es consistente con un análisis cualitativo de las formas de onda presentadas en la @fig-ruido. 
